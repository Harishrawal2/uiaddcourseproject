...
import termsAndCondition from '../../assests/docs/termAndCondition';

const Founder = () => (
  <Stack direction={['column', 'row']} spacing={['4', '16']} padding={'8'}>
    <VStack>
      <Avatar
        src="https://avatars.githubusercontent.com/u/85441728?v=4"
        boxSize={['40', '48']}
      />
    ...
    <VStack justifyContent={'center'} alignItems={['center', 'flex-start']}>
      <Heading children="Harish Rawal" size={['md', 'xl']} />
      <Text
